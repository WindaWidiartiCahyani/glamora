...
#         return format_html("<a href='https://api.whatsapp.com/send?phone={url}&text=Apakah%20anda%20telah%20memesan%20produk%20di%20Meubel%20tersebut?' target='_blank'>{url}</a>", url=obj.whatsapp)
...
class DetailTransaksiAdmin(admin.ModelAdmin):
    list_display = ['no_transaksi','produk','harga','jumlah','sub_total']
    list_filter = ['no_transaksi']
    # readonly_fields = ["no_transaksi","produk","jumlah"]
